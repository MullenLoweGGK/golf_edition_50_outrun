...
import { WIDTH, HEIGHT, SEGMENT_LENGTH, DRAW_DISTANCE, FOG_DENSITY, ROAD_WIDTH, ROAD_VISUAL_WIDTH_MULTIPLIER } from '../constants/index.js'
  ...
  static forestroke ({ context, ferrari, camera, road, y, checkpoints }) {
    ...
    for (let i = 0; i < DRAW_DISTANCE; ++i) {
      ...
      segment.updateMidPoints({
        x: ferrari.position.x * ROAD_WIDTH * ROAD_VISUAL_WIDTH_MULTIPLIER - x,
        y,
