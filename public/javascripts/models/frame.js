...
import { ROAD_WIDTH, ROAD_VISUAL_WIDTH_MULTIPLIER, CAMERA_DEPTH, WIDTH, HEIGHT } from '../constants/index.js'
...
class Frame {
  ...
  project (camera) {
    ...
    this.screen.width = Math.round(this.screen.scale * ROAD_WIDTH * ROAD_VISUAL_WIDTH_MULTIPLIER * WIDTH / 2)
