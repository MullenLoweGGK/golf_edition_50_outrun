...
// Lower position by 50% of original height (41px) so 68px-tall sprite fits
const HERO_Y_OFFSET = 21 // ~50% of 41px = move car down
const HERO_Y_MIN = 400
